...
namespace QLKS
{
    public partial class CustomerRes : Form, IView
    {
        ...
        public CustomerRes()
        {
            ...
            txtDob.Format = System.Windows.Forms.DateTimePickerFormat.Custom;

            txtCheckIn.CustomFormat = "dd/MM/yyyy";
            txtCheckIn.Format = System.Windows.Forms.DateTimePickerFormat.Custom;
        ...
        public void SetDataToText()
        {
            ...
            // Định dạng lại cho các trường ngày tháng trong TextBox
            txtDob.Text = customer.dob.ToString("dd/MM/yyyy");
            txtCheckIn.Text = customer.checkin.ToString("dd/MM/yyyy");
            txtCheckOut.Text = customer.checkout?.ToString("dd/MM/yyyy") ?? string.Empty;
        ...
        private void ClearForm()
        {
            ...
            txtIDProof.Clear();
            txtAddress.Clear();
            txtCheckIn.Value = DateTime.Today;  
            txtCheckOut.Value = DateTime.Today;  
